...
func TestLen(t *testing.T) {
	const fname = "TestLen"
	m := &IntSet{
		words: []uint{0b10001, 0b10001, 0, 0b10101010},
	}
	l := m.Len()
	exp := 8
	if l != exp {
...
func TestDifferenceWith(t *testing.T) {
	...
	m := &IntSet{
		words: []uint{0b10001, 0b10101, 0, 0b10101010, 0b101},
	}
	m2 := &IntSet{
		words: []uint{0b10001, 0b10001, 0b01010, 0b10101010},
	}
	m.DifferenceWith(m2)
	str := m.String()
	exp := "{66 256 258}"
...
func TestSymmetricDifferenceWith(t *testing.T) {
	...
	m := &IntSet{
		words: []uint{0b10001, 0b10101, 0b00000, 0b10101010, 0b0101},
	}
	m2 := &IntSet{
		words: []uint{0b10001, 0b10001, 0b01010, 0b10101010, 0b1010, 0b1100},
	}
	m3 := &IntSet{
		words: []uint{0b00000, 0b00100, 0b01010, 0b00000000, 0b1111, 0b1100},
	}
