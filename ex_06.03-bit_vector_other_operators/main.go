// Exercise 6.03: (*IntSet).UnionWith computes the union of two sets
// using |, the word-parallel bitwise OR operator. Implement methods
// for IntersectWith, DifferenceWith, and SymmetricDifference for the
